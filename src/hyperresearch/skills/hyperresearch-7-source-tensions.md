...
description: >
  ...
  disagreements from the corpus into output/runs/<vault_tag>/temp/source-tensions.json,
...
6. **Write `output/runs/<vault_tag>/temp/source-tensions.json`:**
   ```json
   {
     "tensions": [
       {
...
- `output/runs/<vault_tag>/temp/source-tensions.json` exists with << p.source_tensions|dash >> tensions
